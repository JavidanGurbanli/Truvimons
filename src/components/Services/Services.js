  ...
  return (
    <section className="services" id="services">
        ...
        <div className="services_cards">
            <div className="card">
                <div className="card_img"><img src={MarketAnalysis} alt="Market Analysis"/></div>
                <h2>Market analysis</h2>
                <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts</p>
            </div>
            <div className="card">
                <div className="card_img"><img src={AppPromotion} alt="App Promotion"/></div>
                <h2>App Promotion</h2>
                <p>Separated they live in Bookmarksgrove right at the coast of the Semantics, a large language ocean.</p>
            </div>
            <div className="card">
                <div className="card_img"><img src={LandingAnalysis} alt="Landing Analysis"/></div>
                <h2>Landing Analysis</h2>
                <p>A small river named Duden flows by their place and supplies it with the necessary.</p>
            </div>
        </div>
        <div className="business">
            <div className="business_img"><img src={SetupAnalytics} alt="Setup Analytics"/></div>
